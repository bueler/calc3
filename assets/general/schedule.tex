...
\wkday{10}{3/20}{3/24}    & \phantom{x} \par \hdue{5.1} & 5.2 \par \hdue{5.2} & 5.3 \par \qq{Q7} & 5.4 \\ \hline

\wkday{11}{3/27}{3/31}    & 2.7 \par \hdue{5.3} & 5.5 \par \hdue{5.4} & 5.7 \par \qq{Q8} & \phantom{x} \par \dl{withdrawals} \\ \hline

\wkday{12}{4/3}{4/7}      & 6.1 \par \hdue{2.7, 5.5} & \phantom{x} \par \hdue{6.1} & \ee{Midterm 2} & 6.2 \\ \hline

\wkday{13}{4/10}{4/14}    & 6.3 \par \hdue{6.2} & 6.4 \par \hdue{6.3} & \phantom{x} \par \qq{Q9} & 6.5 \\ \hline

\wkday{14}{4/17}{4/21}    & \phantom{x} \par \hdue{6.4} & 6.6 \par \hdue{6.5} & 6.7 \par \qq{Q10} & \phantom{x} \\ \hline

\wkday{15}{4/24}{4/28}    & 6.8 \par \hdue{6.6} & \phantom{x} \par \hdue{6.7} & \phantom{x} \par \qq{Q11} & review \\ \hline
