...
\wkday{11}{3/27}{3/31}    & 5.4 \par \hdue{5.3} & 2.7 \par \hdue{5.4} & 5.5 \par \qq{Q8} & \phantom{x} \par \dl{withdrawals} \\ \hline

\wkday{12}{4/3}{4/7}      & \phantom{x} \par \hdue{2.7} & 6.1 \par \hdue{5.5} & \ee{Midterm 2} & 6.2 \\ \hline

\wkday{13}{4/10}{4/14}    & 6.3 \par \hdue{6.1, 6.2} & 6.4 \par \hdue{6.3} & \phantom{x} \par \qq{Q9} & 6.5 \\ \hline
