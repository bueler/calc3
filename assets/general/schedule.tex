...
\wkday{1}{1/16}{1/20}     & \vac{Civil Rights Day} & 2.1 & 2.2, 2.3 & \phantom{x} \par \hdue{2.1} \\ \hline

\wkday{2}{1/23}{1/27}     & 2.4 \par \hdue{2.2} & 2.5 \par \hdue{2.3} & \phantom{x} \par \qq{Q1} & 3.1 \par \dl{drops} \\ \hline

\wkday{3}{1/30}{2/3}      & \phantom{x} \par \hdue{2.4} & 3.2 \par \hdue{2.5} & \phantom{x} \par \qq{Q2} & 3.3 \par \hdue{3.1} \\ \hline
