...
\wkday{5}{2/13}{2/17}     & \phantom{x} \par \hdue{3.3} & 4.2 \par \hdue{4.1} & \phantom{x} \par \qq{Q4} & 4.3 \\ \hline

\wkday{6}{2/20}{2/24}     & \phantom{x} \par \hdue{4.2} & 4.4 \par \hdue{4.3} & \ee{Midterm 1} & 4.5 \\ \hline

\wkday{7}{2/27}{3/3}      & 4.6 \par \hdue{4.4} & \phantom{x} \par \hdue{4.5} & 4.7 \par \qq{Q5} & 4.8 \par \hdue{4.6} \\ \hline

\wkday{8}{3/6}{3/10}      & 5.1 \par \hdue{4.7} & 5.2 \par \hdue{5.1} & \phantom{x} \par \qq{Q6} & 5.3 \\ \hline
